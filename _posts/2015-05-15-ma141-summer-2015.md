...
<div class="row">
    <div class="col-lg-12">
        ...
        <tr>
            ...
            <td bgcolor="#fedebe" style="text-align:right;">&nbsp;4:20 PM - &nbsp;5:50 PM</td>
    ...
    <div class="col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item"><strong>Math Tutoring Center</strong>:<br/> The Math Tutoring center will be open Monday through Friday from 10:00 AM to 1:00 PM.<br/>
                <p style="width:75%; text-align:center:margin-right:auto; margin-left:auto;"><img src="/images/Summer2015TutoringSchedule.png" style="width:100%"></p></li>
        </ul>
    </div>
</div>
