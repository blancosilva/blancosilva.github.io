    ...
    <div class="col-lg-12">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td bgcolor="#fedebe" style="text-align:right;">&nbsp;4:30 PM - &nbsp;5:30 PM</td>
        ...
        <tr>
            ...
            <td bgcolor="#fedebe" style="text-align:right;">&nbsp;4:h0 PM - &nbsp;5:50 PM</td>
...
<div class="row">
    <div class="col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item"><strong>Math Tutoring Center</strong>:<br/> The Math Tutoring center will be open Monday through Friday from 10:00 AM to 1:00 PM.<br/>
                <p style="width:100%; text-align:center:margin-right:auto; margin-left:auto;"><img src="/images/Summer2015TutoringSchedule.png" style="width:100%"></p></li>
        </ul>
    </div>
</div>
    ...
    <ul>
        <li><strong>First part: Functions</strong>
            <ul>
                ...
                <li><strong>Thu Jun 04</strong>: <font color="red">First Midterm---sections 1.2, 1.3, 1.5, 1.6, 2.2, 2.3, and 2.5</font></li>
            </ul>
        </li>
        ...
        <li><strong>Third Part: Applications of Differentiation</strong>
            <ul>
                ...
                <li><strong>Wed Jan 17</strong>: 3.9: Related Rates II.  4.7 Optimization Problems I<br /><font color="blue">[Quiz #4 due today]</font></li>
                <li><strong>Thu Jan 18</strong>: 4.7: Optimization Problems II<br /><font color="blue">[Quiz #5 due today]</font></li>
