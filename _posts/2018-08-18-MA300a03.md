...
{:start="13"}
13. \\( \big\lvert \mathcal{P} \bigg( \mathcal{P} \big( \mathcal{P} (A) \big) \bigg) \big\rvert \\)
...
19. \\( \big\lvert \mathcal{P} \bigg( \mathcal{P} \big( \mathcal{P} (A \times \emptyset) \big) \bigg) \big\rvert \\)
