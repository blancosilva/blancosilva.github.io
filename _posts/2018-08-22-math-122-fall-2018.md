...
<div class="alert alert-warning" role="alert" style="text-align:center;">
	<strong><tt>F = 0.1 * (HW + Q) + 0.15 * (T1 + T2 + T3 + T4) + 0.2 * FE</tt></strong>
</div>
...
<ul class="list-group">
	...
	<li class="list-group-item">
		...
		<p class="list-group-item-text">
			Each test counts 15%, for a total of 60% of the course grade. There will be four in-class tests tentatively scheduled as follows:
			<div class="row">
