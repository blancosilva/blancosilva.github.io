...
<div class="well">
  <ul class="list-group">
	...
	—The Chain Rule
      ...
      <p class="list-group-item-text">
	<tt>[p.121 #7—12]</tt> &nbsp;
	<a href="http://blancosilva.github.io/forum/2018/10/14/MA122L10.html" class="btn btn-secondary btn-sm active" role="button" aria-pressed="true">Answers</a>
      </p>	
    </li>
    <li class="list-group-item">
    ...
    <!--   </p>	 -->
	 ...
	 <li class="list-group-item">
      ...
      <p class="list-group-item-text" style="color:green;">
	Online review for Test #2. [<a href="https://webconnect.sc.edu/pxqshoch6xts/">video</a> | <a href="/images/review2ma122.pdf">pdf</a>]
      </p>
    </li>
    <li class="list-group-item">
	...
	<a href="http://blancosilva.github.io/forum/2018/11/03/MA122L12.html" class="btn btn-secondary btn-sm active" role="button" aria-pressed="true">Answers</a>	
      </p>
    </li>
    <li class="list-group-item">
	...
	Test #3. Applications of the Derivative 
		...
		<p class="list-group-item-text">
		[<a href="https://webconnect.sc.edu/pev8fydlfexx/">Recording of online
  review session</a> | <a href="/images/review3ma122.pdf">Transcript (pdf)</a>]
	</p>
    </li>
    <li class="list-group-item">
      <h4 class="list-group-item-heading">Tue, Nov 13</h4>
      <p class="list-group-item-text">
	The Integral
      </p>
      <p class="list-group-item-text">
	...
	<tt>[p.196 #1—10]</tt> &nbsp; <p class="list-group-item-text"> &nbsp; <a
	href="http://blancosilva.github.io/forum/2018/11/17/MA122L13.html" class="btn btn-secondary btn-sm active"
	role="button" aria-pressed="true">Answers</a>
      </p>
    </li>
    <li class="list-group-item">
	...
	—Antiderivative Rules: Substitution
      ...
      <p class="list-group-item-text">
	<tt>[p.202 #1—8]</tt> &nbsp; <a href="http://blancosilva.github.io/forum/2018/11/17/MA122L14.html" class="btn
	btn-secondary btn-sm active" role="button" aria-pressed="true">Answers</a>	 
      </p>
    </li>
    <li class="list-group-item">
