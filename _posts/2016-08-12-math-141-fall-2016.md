    ...
    <ul>
        <li><strong>First part: Functions</strong>
            <ul>
                ...
                <li><strong>Wed Sep 07</strong>: <font color="red">First Midterm---sections 1.1, 1.2, 1.5, 1.6, 2.2, 2.4, 2.5 and 2.6</font></li>
            </ul>
        </li>
        ...
        <li><strong>Fourth Part: Introduction to Integration</strong>
            <ul>
                ...
                <li><strong>Mon Nov 21</strong>: <font color="red">Fifth Midterm---sections 4.8, 5.1, 5.2, 5.3, 5.4 and 5.5</font></li>
            </ul>
        </li>
