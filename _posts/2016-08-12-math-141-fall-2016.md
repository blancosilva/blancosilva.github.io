    ...
    <div class="col-sm-8 col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:grantld@email.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading"><strong>Teaching Assistant</strong>: David Kleckley Hughey</h4>
                <p class="list-group-item-text">
    ...
    <div class="col-sm-12 col-lg-12">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td style="text-align:left;" bgcolor="#fedebe">LeConte 122A</td>
        </tr>
    </table>
</div>
</div>
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <strong>Final Exam</strong>: (up to 100 points) 30% of the course grade.<br />  The final exam is scheduled on Monday, December 5th, 2016 at 4:00 PM.
            </li>
        </ul>
    </div>
</div>
    ...
    <ul>
        <li><strong>First part: Functions</strong>
            <ul>
                ...
                <li><strong>Wed Sep 07</strong>: <font color="red">First Midterm---sections 1.1, 1.2, 1.5, 1.6, 2.2, 2.4, 2.5 and 2.6</font></li></li>
            </ul>
        </li>
        <li><strong>Second Part: Introduction to Differentiation</strong>
            <ul>
                <li><strong>Mon Sep 12</strong>: 2.1, 3.1, 3.2 & 3.3 & 3.8</li>
                <li><strong>Wed Sep 14</strong>: 3.3 & 3.6</li>
                <li><strong>Mon Sep 19</strong>: 1.3 & 3.5</li>
                <li><strong>Wed Sep 21</strong>: 3.7</li>
                <li><strong>Mon Sep 26</strong>: <font color="red">Second Midterm---sections 2.1, 3.1, 3.2, 3.3, 3.5, 3.6, 3.7 and 3.8</font></li>
            </ul>
        </li>
        <li><strong>Third Part: Applications of Differentiation</strong>
            <ul>
                <li><strong>Wed Sep 28</strong>: 4.1, 4.3 & 4.4</li>
                <li><strong>Mon Oct 03</strong>: 4.4. (cont'd) or 4.5</li>
                <li><strong>Wed Oct 12</strong>: 4.5</li>
                <li><strong>Mon Oct 17</strong>: <font color="red">Third Midterm---sections 4.1, 4.3, 4.4, and 4.5</font>
                <li><strong>Wed Oct 19</strong>: 3.10 & 4.6</li>
                <li><strong>Mon Oct 24</strong>: 3.10 & 4.6</li>
                <li><strong>Wed Oct 26</strong>: 3.10 & 4.6</li>
                <li><strong>Mon Oct 31</strong>: <font color="red">Fourth Midterm---sections 4.1, 4.2, 4.3, 4.4, and 4.5</font></li>
            </ul>
        </li>
        <li><strong>Fourth Part: Introduction to Integration</strong>
            <ul>
                ...
                <li><strong>Wed Nov 09</strong>: 4.8 & 5.5</li>
                <li><strong>Mon Nov 14</strong>: 5.5 (cont'd)</li> 
                <li><strong>Wed Nov 16</strong>: 5.3 & 5.4</li>
                <li><strong>Mon Nov 21</strong>: <font color="red">Fifth Midterm---sections 4.8, 5.1, 5.2, 5.3, 5.4 and 5.5</font>
            </ul>
        </li>
