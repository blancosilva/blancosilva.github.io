    ...
    <ul>
        <li><strong>First part: Functions</strong>
            <ul>
                ...
                <li><strong>Wed Sep 07</strong>: <br/><font color="red">First Midterm---1.1, 1.2, 1.5, 1.6, 2.2, 2.4, 2.5 and 2.6</font></li>
            </ul>
        </li>
        <li><strong>Second Part: Introduction to Differentiation</strong>
            <ul>
                ...
                <li><strong>Mon Sep 26</strong>: <br/><font color="red">Second Midterm---2.1, 3.1, 3.2, 3.3, 3.5, 3.6, 3.7 and 3.8</font></li>
            </ul>
        </li>
        <li><strong>Third Part: Applications of Differentiation</strong>
            <ul>
                ...
                <li><strong>Mon Oct 17</strong>: <br/><font color="red">Third Midterm---4.1, 4.3, 4.4, and 4.5</font></li>
                <li><strong>Wed Oct 19</strong>: 3.10 & 4.6</li>
                <li><strong>Mon Oct 24</strong>: 3.10 & 4.6</li>
                <li><strong>Wed Oct 26</strong>: 3.10 & 4.6</li>
                <li><strong>Mon Oct 31</strong>: <br/><font color="red">Fourth Midterm---4.1, 4.2, 4.3, 4.4, and 4.5</font></li>
            </ul>
        </li>
