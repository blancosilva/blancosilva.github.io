    ...
    <ul>
        ...
        <li><strong>Second Part: Introduction to Differentiation</strong>
            <ul>
                ...
                <li><strong>Wed Sep 28</strong>: 3.8, 3.9 [p.186 #89--96.  p.192 #21--26,33,34,42]</li>
                <li><strong>Mon Oct 03</strong>: <br/><font color="red">Second Midterm---1.3, 3.3, 3.5, 3.6, 3.7, 3.8 and 3.9</font></li>
            </ul>
        </li>
        <li><strong>Third Part: Applications of Differentiation</strong>
            <ul>
                <li><strong>Wed Oct 12</strong>: 2.1, 3.1 & 3.2</li>
