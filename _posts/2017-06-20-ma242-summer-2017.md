		...
		<div class="list-group">
            <a href="mailto:blanco@math.sc.edu" class="list-group-item">
                ...
                <p class="list-group-item-text">
                    ...
                    <strong>Office Hours</strong>: MTWTh 4:00 PM - 6:00 PM
                </p>
            </a>
        </div>
	</div>	
	...
	<div class="col-sm-12 col-lg-12">
		<ul class="list-group">
        	...
        	<li class="list-group-item">
        		...
        		If you are unhappy with the final score obtained from the in-class exams, notify me <strong>by email on Thursday, Aug 10, before 8:00 PM.</strong>  You will have an opportunity to change your course grade by taking a (comprehensive) final exam on Saturday, August 12th, at 12:30 PM.<br/>
        		<strong>The score of the final will substitute your previous grade</strong>.
        	</li>
        </ul>
    </div>
</div>
...
<div class="well">
	<h2>Lesson Plan</h2>
	<ul class="list-group">
		<li class="list-group-item"><strong>First part: Introduction to Differential Equations</strong>
		...
		<li class="list-group-item"><strong>Second Part: Laplace Transform</strong>
			<uli style="font-family:Courier;" >
				<li> 
		...
		<li class="list-group-item"><strong>Third Part: Applications to Mathematical Modeling</strong>
			<uli style="font-family:Courier;" >
				<li>
