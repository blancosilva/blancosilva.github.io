...
<div class="well">
<ul style="font-family:Courier;" class="list-group">
	<li class="list-group-item"><strong>First part: Introduction to Differential Equations---Classical Methods</strong>
		<ul>
			<li>
