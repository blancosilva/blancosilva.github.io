...
<ul style="font-family:Courier;">
	<li><strong>First part: Introduction to Differential Equations---Classical Methods</strong>
		<ul>
			...
			<li>
				...
				- the method of undetermined coefficients (Part I: the easy examples)<br/>
				[p.210 #1--56]<br/>
			...
			<li>
				...
				Particular solutions for Second-order linear differential equations with constant coefficients:<br/>
				- the method of undetermined coefficients (Part II: the hard examples)<br/>
	...
	<li><strong>Second Part: Laplace Transform</strong>
		<ul>
			<li> 
				...
				[p.450 #11--32. Find the Laplace transform of $latex \cos ax$, and $latex \sqrt{x}$ using the definition, p.462 #1--16]<br/>
	...
	<li><strong>Fourth Part: Applications to Mathematical Modeling</strong>
		<ul>
			<li>
