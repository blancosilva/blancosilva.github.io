    ...
    <div class="col-lg-12">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td bgcolor="#fedebe" style="text-align:right;"><strong>MW</strong></td>
            <td bgcolor="#fedebe" style="text-align:right;">&nbsp;3:00 PM - &nbsp;5:00 PM</td>
    ...
    <div class="col-lg-12">
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <h3 style="text-align:center;"><span class="label label-warning"><tt>sc 0023 9122</tt></span></h3>
...
<div class="well" style="font-family:Courier; background:white;">
    <ul>
        ...
        <ul>
            <li> Wed Feb 18: 4.1: Maximum and Minimum values I [p.277: 6, 8, 10, 29--44, 47--62], 4.3: First and Second Derivative Test [p.295: 5, 6, 7, 9--22, 33--50] </li>
        ...
        <ul>
            ...
            <li> Wed Apr 15: 6.1: Area between curves I</li>
            <li> Fri Apr 17: 6.1: Area between curves II</li>
            <li> Mon Apr 20: Fifth Midterm---sections 4.9, 5.1, 5.2, 5.3, 5.4, 6.1, and Appendix E</li>
        </ul>
