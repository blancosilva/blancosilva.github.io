...
<div class="row">
    ...
    <div class="col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:xyi@math.sc.edu" class="list-group-item">        
    ...
    <div class="col-lg-12">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td bgcolor="#f4f5f7" style="text-align:center;"><strong>M</strong></td>
          ...
          <tr>
            ...
            <td bgcolor="#fedebe" style="text-align:center;"><strong>TThF</strong></td>
            <td bgcolor="#fedebe" style="text-align:right;">10:00 AM - 11:00 AM</td>
    ...
    <div class="col-lg-12">
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <h3 style="text-align:center;"><span class="label label-warning"><tt>sc 4076 8800</tt></span></h3>
                        ...
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">Tue, Feb 17</td>
                                </tr>
                                <tr>
                                    <td align="center"><strong>3</strong></td>
                                    <td align="center">Tue, Mar 17</td>
                                </tr>
                                <tr>
                                    <td align="center"><strong>4</strong></td>
                                    <td align="center">Thu, Apr 02</td>
                                </tr>
                                <tr>
