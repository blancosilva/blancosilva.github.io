...
1. Compute the following integrals:
	<div>
		\begin{align}
		&\int \cos^3 \tfrac{x}{2} \csc^2 \tfrac{x}{2}\, dx &&\int p(p+5)^8\, dp \\
		&\int x^3\sqrt{x^2-6}\, dx &&\int e^x \cos x\, dx \\
		&\int x^3e^{2x}\, dx &&\int x^2\sin x\, dx \\
		&\int \sin^3 x\cos^2 x\, dx && \int x\sin^{-1}x^2\, dx && \int x\ln x\, dx \\
		&\int e^x\sec^2 x\, dx &&\int 6\cos^3 \tfrac{x}{10}\, dx \\
		&\int 4\cos^2 2\theta \sin2\theta\, d\theta && \int 10\sin^2 5x \cos^2 5x\, dx \\
