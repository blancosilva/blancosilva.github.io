...
<div class="row">
	<div class="col-sm-12 col-lg-12">
		<ul class="list-group">
			...
			<p class="list-group-item-text">The score of each assignment for any undergraduate students will be averaged over the set of <strong>Basic</strong>, <strong>Intermediate</strong> and <strong>CAS</strong> problems.  Undergraduate students are encouraged to work <strong>Advanced</strong> problems, but this will not grant them extra credit.
			The score of each assignment for any graduate students will be averaged over the set of all stated problems.</p>
			</li>
...
<div class="well">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">—Continuous and Differentiable functions \( f \colon \mathbb{R}^d \to \mathbb{R} \)</p>
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 2.1 — 2.5</strong></p>
		</li>
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 2.6 — 2.9</strong></p>
		</li>
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 2.10 — 2.16</strong></p>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:crimson;">First in-class Exam. Chapters 1 and 2.</p>
		</li>
		<li class="list-group-item">
			...
			<p class="list-group-item-text">—Newton-Raphson Method to solve nonlinear equations \( f(x) = 0 \) for univariate real-valued functions \( f\colon \mathbb{R} \to \mathbb{R} \)</p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">Numerical Approximation for Unconstrained Optimization.</p>
			<p class="list-group-item-text">—Newton-Raphson Method to solve nonlinear equations \( f(\boldsymbol{x}) = 0 \) for multivariate functions \( \boldsymbol{f} \colon \mathbb{R}^d \to \mathbb{R}^d \)</p>
			<p class="list-group-item-text">—Newton-Raphson Method to find local minimum values</p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:crimson;">Second in-class Exam. Chapter 3.</p>
		</li>
		<li class="list-group-item">
