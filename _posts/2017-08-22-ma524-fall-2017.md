...
A grade of **C** or better in MATH 241 (Vector Calculus), and a grade of **C** or better in Linear Algebra (MATH 344 or MATH 544)
...
<div class="well">
	<ul class="list-group">
		<li class="list-group-item">
			...
			<p class="list-group-item-text">blah</p>
		</li>
		<li class="list-group-item">
