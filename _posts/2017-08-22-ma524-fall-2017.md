...
<div class="well">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 3.1 — 3.8</strong></p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 3.9 — 3.17</strong></p>
		</li>
		<li class="list-group-item">
			<h4 class="list-group-item-heading">Th, Sep 28</h4>
			<p class="list-group-item-text">Numerical Approximation for Unconstrained Optimization.</p>
			<p class="list-group-item-text">—Steepest Descent</p>
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 3.18 — 3.23</strong></p>
		</li>
		<li class="list-group-item">
