...
<div class="well">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<a href="http://blancosilva.github.io/forum/2017/09/06/MA523ch1.html"><button type="button" class="btn btn-primary btn-lg btn-block">Forum for Chapter 1</button></a>
		</li>
		<li class="list-group-item">
			...
			<a href="http://blancosilva.github.io/forum/2017/09/06/MA523ch2.html"><button type="button" class="btn btn-primary btn-lg btn-block">Forum for Chapter 2</button></a>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 2.9 — 2.13</strong></p>
		</li>
		<li class="list-group-item">
			<h4 class="list-group-item-heading">Th, Sep 14</h4>
			<p class="list-group-item-text">Existence and Characterization for Unconstrained Optimization.</p>
			<p class="list-group-item-text">—Differentiability and Characterization</p>
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 2.14 — 2.19</strong></p>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Submit 5 problems of your choice among Problems 3.1 — 3.8</strong></p>
			<a href="http://blancosilva.github.io/forum/2017/09/06/MA523ch3.html"><button type="button" class="btn btn-primary btn-lg btn-block">Forum for Chapter 3</button></a>
		</li>
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Submit 5 problems of your choice among Problems 3.9 — 3.17</strong></p>
		</li>
		<li class="list-group-item">
			<h4 class="list-group-item-heading">Th, Sep 28</h4>
			<p class="list-group-item-text">Numerical Approximation for Unconstrained Optimization.</p>
			<p class="list-group-item-text">—Steepest Descent</p>
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Submit 5 problems of your choice among Problems 3.18 — 3.23</strong></p>
		</li>
		<li class="list-group-item">
			<h4 class="list-group-item-heading">Tu, Oct 03</h4>
			<p class="list-group-item-text">Numerical Approximation for Unconstrained Optimization.</p>
			<p class="list-group-item-text">—Secant Methods</p>
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 3.24 — </strong></p>
