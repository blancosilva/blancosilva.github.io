...
<div class="well">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">—Newton-Raphson Method to solve nonlinear equations \( f(\boldsymbol{x}) = 0, f\colon \mathbb{R} \to \mathbb{R} \)</p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">Numerical Approximation for Unconstrained Optimization.</p>
			<p class="list-group-item-text">—Newton-Raphson Method to solve nonlinear equations \( f(\boldsymbol{x}) = 0, f\colon \mathbb{R}^d \to \mathbb{R} \)</p>
