...
<div class="well">
	<ul class="list-group">
		<li class="list-group-item">
			...
			<p class="list-group-item-text">Review of Optimization in the setting of Vector Calculus—Local minima.</p>
		</li>
		<li class="list-group-item">
			<h4 class="list-group-item-heading">Tu, Aug 29</h4>
			<p class="list-group-item-text">Review of Optimization in the setting of Vector Calculus—Global minima.</p>
		</li>
		<li class="list-group-item">
			<h4 class="list-group-item-heading">Th, Aug 31</h4>
			<p class="list-group-item-text">Review of Optimization in the setting of Vector Calculus—Orthogonal Gradient, Lagrange Multipliers.</p>
			<p class="list-group-item-text" style="font-color:cyan">HW Assignment:  Problems 1.1 -- 1.12</p>
		</li>
		<li class="list-group-item">
			...
			<p class="list-group-item-text">Continuity and Differentiability of functions <span>\\( f \colon \mathbb{R}^d \to \mathbb{R} \\)</span></p>
		</li>
		<li class="list-group-item">
