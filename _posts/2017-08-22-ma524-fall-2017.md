...
<div class="well">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">—Continuous and Differentiable functions \( f \colon {R}^d \to {R} \)</p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">—Newton-Raphson Method to solve nonlinear equations \( f(\boldsymbol{x}) = 0 \)</p>
