...
<div class="well">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Problems 2.12 — 2.19</strong></p>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>---Graduate Students: Submit all advanced problems.  Submit one Basic, one Intermediate and one CAS of your choice.</strong></p>
			<p class="list-group-item-text" style="color:teal;"><strong>---Undergraduate Students: Submit 5 problems of your choice.  You may submit more problems for extra credit in Exam #2</strong></p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text" style="color:teal;"><strong>HW Assignment:  Submit 5 problems of your choice among Problems 3.8 — 3.17</strong></p>
		</li>
		<li class="list-group-item">
