...
[people.math.sc.edu/blanco/superior.poly](http://people.math.sc.edu/blanco/superior.poly).
...
> For a complete description of the `poly` format, refer to [www.cs.cmu.edu/~quake/triangle.poly.html](http://www.cs.cmu.edu/~quake/triangle.poly.html).  With that
