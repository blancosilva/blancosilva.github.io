...
<ul class="list-group">
	...
	<li class="list-group-item">The last day to obtain a "W" grade or to elect a pass/fail grade is Monday, October 19th. The first day in which a "WF" grade is assigned is therefore Tuesday, October 20th.</li>
</ul>
...
<div class="alert alert-warning" role="alert" style="text-align:center;">
	<strong><tt>F = 0.15 * (HW + Q) + 0.15 * (ME1 + ME2 + ME3) + 0.25 * FE</tt></strong>
</div>
...
<ul class="list-group">
	...
	<li class="list-group-item"><strong>Midterms</strong>: each test counts 15%, for a total of 45% of the course grade. There will be three in-class midterm exams tentatively scheduled as follows:<br />
	...
	<li class="list-group-item"><strong>Final exam</strong>: 25% of the course grade. The dates for the final exam are: <br/>
		<ul>
...
<ul class="list-group">
	...
	You can find their schedule and contact information at <a href="http://www.sa.sc.edu/supplementalinstruction/">www.sa.sc.edu/supplementalinstruction/</a>.</li>
</ul>
...
<div class="well">
	...
	<ul style="font-family:courier;font-size:12px;text-align:left;">
		...
		<li><strong>Thu Nov 12</strong>: <span style="color:red;">Third Midterm. Sections 3.1--3.4, 4.1--4.4, 7.1, 7.2, and 7.4.</span></li>
	...
	<ul style="font-family:courier;font-size:12px;text-align:left;">
		...
		<li><strong>Wed Nov 11</strong>: <span style="color:red;">Third Midterm. Sections 3.1--3.4, 4.1--4.4, 7.1, 7.2, and 7.4.</span></li>
