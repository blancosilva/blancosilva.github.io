    ...
    <div class="col-sm-12 col-lg-12">
        <ul class="list-group">
            <li class="list-group-item"><strong>Homework assignments</strong>: (up to 100 points) 10% of the course grade.<br />
                ...
                Homework problems have been assigned for each lecture (you can see them at the end of this page, under <strong>Lesson Plan</strong>). A selection of those problems are posted on <a href="http://www.mymathlab.com">MyMathLab</a> on the day of the lecture, and will be graded. <br />
               ...
               <h3 style="text-align:center;"><span class="label label-warning"><tt>blanco-silva86486</tt></span></h3> <br />
        ...
        <li class="list-group-item">
            ...
            <ul>
                ...
                <li><strong>Section 007</strong>: Friday, April 28th,  9:30 am</li>
