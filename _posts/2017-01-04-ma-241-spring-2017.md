...
<div class="well" style="font-family:Courier; background:white;">
	<ul style="font-family:Andale Mono; font-size:9pt;">
        ...
        <li><strong>Second Part: Functions of several variables</strong>
            <ul>
                <li><strong>Mon Feb 06</strong>: 13.1 and 13.2: Vector functions, derivatives and integrals</li>
                <li><strong>Wed Feb 08</strong>: 13.3: Curvature, principal normal</li>
                <li><strong>Fri Feb 10</strong>: 14.1 and 14.2: Intro to functions of several variables. Limits and Continuity</li>
