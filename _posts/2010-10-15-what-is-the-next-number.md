...
The last example of that series is the famous Fibonacci sequence: every number is the sum of the previous two.  The general term of this sequence has therefore the expression <span>\\( x_n = x_{n-1} + x_{n-2}. \\)</span>
