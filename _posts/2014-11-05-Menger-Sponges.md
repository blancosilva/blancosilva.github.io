...
<ul class="nav nav-pills" role="tablist">
	<li role="presentation" class="active"><a href="#">Card Collection <span class="badge">48,000</span></a>
	...
	<li role="presentation" class="active"><a href="#">Sponge Construction <span class="badge">20 &times; 20 &times; 20</span></a>
		<div class="progress">
		<!-- 	<div class="progress-bar progress-bar-warning" style="width: 5%"><span class="sr-only">Level-2</span></div>
			<div class="progress-bar progress-bar-warning" style="width: 5%"><span class="sr-only">Level-2</span></div>
			<div class="progress-bar progress-bar-warning" style="width: 5%"><span class="sr-only">Level-2</span></div>
