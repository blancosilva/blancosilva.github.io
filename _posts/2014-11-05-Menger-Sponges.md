...
I know it is hard to grasp, but it is _mathematically viable_: there are solids that require an infinite amount of material to construct, yet they have no volume!  Of course, the obvious infinity surface area makes it impossible to actually construct these objects physically, but it is feasible to come up with reasonable approximations.  One approximation to such a construction---the so-called Menger sponge---goes like this:
...
<p style="text-align:center;"><img src="https://farm7.staticflickr.com/6227/6315682009_3f42068116_n_d.jpg" style="width:50%; border:2px solid black;"><br /><a href="https://www.flickr.com/photos/rougeux/sets/72157621702780335/">Level 3 Menger Sponge folded with <em>Post-its</em></a><br/>(Copyright)  All rights reserved by <a href="https://www.flickr.com/photos/rougeux/">Nick Rogeux</a></p>
...
<p style="text-align:center;"><img src="http://www.theiff.org/images/paper/mosleypic.jpg" style="border:2px solid black; width:50%;"><br />Dr. Mosley, inside of her <em>Business Card Menger Sponge</em><br />(Photo by Ravi Apte)</p>
...
But there is no need to wait 10 years to get this done.  Some folks at the Queen Mary University of London figured out a way to reduce the assembly time to just a few days, and posted detailed instructions at <a href="http://megamenger.com">megamenger.com</a>.
...
<div class="progress">
	...
	<div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="00" aria-valuemin="0" aria-valuemax="100" style="width: 5%"><span class='sr-only'>Level-2</span></div>
