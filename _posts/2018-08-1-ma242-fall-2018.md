	...
	<div class="col-sm-12 col-lg-12">
		<ul class="list-group">
        	...
        	<li class="list-group-item">
        		...
        		If you have taken at least three of the in-class exams, and are unhappy with your potential final score (as computed with the formula above), notify me <strong>by email on Friday, November 30, before 6:00 PM.</strong>  You will have an opportunity to change your course grade by taking a (comprehensive) final exam.  <strong>The score of the final will substitute your previous grade</strong>.<br/>
	...
	<ul class="list-group">
		<li class="list-group-item">
			...
			<ul style="font-family:Courier;" >
				<li>
					<strong>Fri Aug 24</strong>: 1.1.  General Introduction to Differential Equations</li><br/>
					 [p.8 #1--26]
				</li>
				<li>
