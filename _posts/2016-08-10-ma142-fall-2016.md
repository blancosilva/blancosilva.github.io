...
<div class="well" style="font-family:Courier; background:white;">
    <ul style="font-family:Andale Mono;">
        ...
        <ul>
            ...
            <li><strong>Tu Sep 13</strong>: 5.4. The Fundamental Theorem of Calculus.s<br />[p.336 #1--22,39a--44a]</li> 
            <li><strong>Th Sep 15</strong>: 8.8. Improper integrals.<br />[p.513 #1--15,21,22,24,25,26]</li>
        ...
        <ul>
            ...
            <li><strong>Tu Oct 11</strong>: 10.4 & 10.5. Comparison tests (II). Alternating series and Conditional Convergence.</li>
            <li><strong>Tu Oct 18</strong>: 10.6. Absolute convergence. Ratio and root tests</li>
