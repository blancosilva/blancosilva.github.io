    ...
    <div class="col-sm-8 col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:ferrerrj@email.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading"><strong>Teaching Assistant</strong>: Lauretta Grant</h4>
                <p class="list-group-item-text">
    ...
    <div class="col-sm-12 col-lg-12">
        <table class="table table-bordered">
            <tr>
                ...
                <td bgcolor="#bb9999" style="text-align:center;"><strong>TuTh</strong></td>
            ...
            <tr>
                ...
                <td bgcolor="#bebebe" style="text-align:center;"><strong>We</strong></td>
            ...
            <tr>
                ...
                <td bgcolor="#f4f5f7" style="text-align:center;"><strong>We</strong></td>
            ...
            <tr>
                ...
                <td bgcolor="#bebebe" style="text-align:left;">Section 005</td>
                <td bgcolor="#bebebe" style="text-align:center;"><strong>Fr</strong></td>
                <td bgcolor="#bebebe" style="text-align:right;">&nbsp;8:30 AM - &nbsp;9:20 AM</td>
                <td bgcolor="#bebebe" style="text-align:left;">LeConte 121</td>
            </tr>
            <tr>
                <td bgcolor="#f4f5f7" style="text-align:left;">Section 006</td>
                <td bgcolor="#f4f5f7" style="text-align:center;"><strong>Fr</strong></td>
                <td bgcolor="#f4f5f7" style="text-align:right;">&nbsp;9:40 AM - 10:30 AM</td>
            ...
            <tr>
              ...
              <td bgcolor="#fedebe" style="text-align:right;"><strong>MoTuWeThFr</strong></td>
              <td bgcolor="#fedebe" style="text-align:right;">&nbsp;2:00 PM - &nbsp;3:00 PM</td>
              <td bgcolor="#fedebe" style="text-align:left;">LeConte 314D</td>
          </tr>
          <tr>
            <td bgcolor="#fedebe" style="text-align:center;">Lauretta</td>
...
A graphing calculator is required for some parts of this course. Either the TI-83 or TI-84 is preferred, and as a matter of fact, highly recommended. A TI-89 or a similar calculator with a computer algebra system is not allowed on examinations.
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <strong>Quizzes</strong>: (up to 100 points) 10% of the course grade.<br />   A 15-minute quiz will be given in every recitation, except on the week of a midterm exam, or the last week of classes.  At the end of the course, you will hopefully have taken at least 10 quizzes.  If that is the case, only the 10 best scores will count toward your quiz average.  
            </li>
            <li class="list-group-item">
                <strong>Computer Labs</strong>: (up to 100 points) 10% of the course grade.
            </li>
            <li class="list-group-item">
                <strong>Midterm Exams</strong>: (up to 100 points each) 40% of the course grade (10% each midterm).<br />  There will be four in-class midterm exams scheduled as follows:
...
<ul class="list-group">
    ...
    <li class="list-group-item">The <a href="http://www.sa.sc.edu/supplementalinstruction/">Supplemental Instructor</a> is <a href="mailto:tba@email.sc.edu">TBA</a>.
    </ul>
...
<div class="well" style="font-family:Courier; background:white;">
    <ul style="font-family:Andale Mono;">
        ...
        <ul>
            <li><strong>Th Aug 18</strong>: Syllabus review.  Background Calculus</li>
            <li><strong>Tu Aug 23</strong>: 5.5. Indefinite Integrals and the Substitution Method</li>
            ...
            <li><strong>Tu Sep 06</strong>: 8.5. Integration of rational functions by partial fraction decomposition I</li>
            <li><strong>Tu Sep 08</strong>: Integration Review</li>
            <li><strong>Tu Sep 13</strong>: <span style="color:red;">First Test. Sections 5.5, 8.2 through 8.5.</span></li>
        </ul>
        <li>Part 2: The Fundamental Theorem of Calculus, and Improper Integrals</li>
        <ul>
            <li><strong>Th Sep 15</strong>: 5.4. The Fundamental Theorem of Calculus</li>
            <li><strong>Tu Sep 20</strong>: 8.8. Improper integrals I</li>
            <li><strong>Th Sep 22</strong>: 8.8. Improper integrals II</li>
            <li><strong>Tu Sep 27</strong>: <span style="color:red;">Second Test. Sections 5.4 and 8.8.</span></li>
        </ul>
        <li>Part 3: Sequences and Series</li>
        <ul>
            <li><strong>Th Sep 29</strong>: 10.1. Sequences</li>
            <li><strong>Tu Oct 04</strong>: 10.2. Introduction to infinite series [p.694 #9, 11-40]</li>
            <li><strong>Th Oct 06</strong>: 10.3. The Integral test</li>
            <li><strong>Tu Oct 11</strong>: 10.4. Comparison tests</li>
            <li><strong>Th Oct 18</strong>: 10.5. Absolute convergence.  The ratio and root tests</li>
            <li><strong>Tu Oct 20</strong>: 10.6. Alternating Series and Conditional Convergence</li>
            <li><strong>Tu Oct 25</strong>: <span style="color:red;">Third Test. Sections 10.1 through 10.6.</span></li>
        </ul> 
        <li>Part 4: Power Series</li>
        <ul>
            <li><strong>Th Oct 27</strong>: 10.7. Power series</li>
            <li><strong>Tu Nov 01</strong>: 10.8. Taylor and MacLaurin Series I</li>
            <li><strong>Th Nov 03</strong>: 10.8. Taylor and MacLaurin Series II</li>
            <li><strong>Th Nov 10</strong>: <span style="color:red;">Fourth Test. Sections 10.7 and 10.8.</span> </li>
        </ul>
        <li>Part 5: Planar Curves</li>
        <ul>
            <li><strong>Tu Nov 15</strong>: 11.1. Parameterization of plane curves</li>
            <li><strong>Th Nov 17</strong>: 11.2. Calculus with parametric curves</li>
            <li><strong>Tu Nov 22</strong>: 11.3 & 11.4. Polar coordinates</li>
            <li><strong>Tu Nov 29</strong>: 11.5. Areas and lengths in polar coordinates.</li>
        </ul>
        <li>Part 6: Special topics.</li>
        <ul>
            <li><strong>Tu Dec 01</strong>: 8.7, 10.9 & 10.10. Numerical Integration.  Remainder estimation, and other applications of Taylor polynomials</li>
        </ul>
    </ul>
</div>