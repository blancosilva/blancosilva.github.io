...
<div class="well" style="font-family:Courier; background:white;">
    <ul style="font-family:Andale Mono;">
        ...
        <ul>
            <li><strong>Th Nov 10</strong>: 11.1 & 11.2. Parameterization of plane curves.<br />Calculus with parametric curves.
                <br/>[p.659 1--5,10,11,21--26, p.669 #25--30]
                <br/>[<strong>Calculator:</strong> p.660 41--48]
            </li>
            <li><strong>Tu Nov 15</strong>: 11.3, 11.4 & 11.5. Polar coordinates.<br />[p.674 #1--10,27--30,33--36,47--50]<br/>[p.682 #1,3,5,6,21,23,27]</li>  
