    ...
    <div class="col-sm-8 col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:grantld@email.sc.edu" class="list-group-item">        
                ...
                <p class="list-group-item-text">
                    <strong>e-mail</strong>: <tt>grantld at email dot sc dot edu</tt><br />
...
<ul class="list-group">
    ...
    <li class="list-group-item"><strong>Student Success Center:</strong><br />
        ...
        <li class="list-group-item">The <a href="http://www.sa.sc.edu/supplementalinstruction/">Supplemental Instructor</a> is <a href="mailto:tba@email.sc.edu">TBA</a>.  You can find his schedule and contact information at <a href="http://www.sa.sc.edu/supplementalinstruction/">www.sa.sc.edu/supplementalinstruction/</a>.</li>
    </ul>
...
<div class="well" style="font-family:Courier; background:white;">
    <ul style="font-family:Andale Mono;">
        <li>Part 1: Integration Techniques, the Fundamental Theorem of Calculus, and Improper integrals.</li>
        <ul>
            ...
            <li><strong>Tu Sep 06</strong>: 8.5. Integration of rational functions by partial fraction decomposition.</li>
            ...
            <li><strong>Tu Sep 20</strong>: <span style="color:red;">First Test. Sections 5.4, 5.5, 8.2 through 8.5, and 8.8.</span></li> 
        </ul>
        <li>Part 2: Sequences, Series, and Power Series.</li>
        <ul>
            ...
            <li><strong>Th Oct 06</strong>: 10.5. Absolute convergence.  The ratio and root tests.</li> 
            <li><strong>Tu Oct 11</strong>: 10.6. Alternating series and conditional convergence.</li>
            <li><strong>Th Oct 18</strong>: <span style="color:red;">Second Test. Sections 10.1 through 10.6.</span></li>
        </ul>
        ...
        <ul>
            ...
            <li><strong>Th Oct 27</strong>: 10.10. The binomial series and applications of Taylor polynomials.</li>
            <li><strong>Tu Nov 01</strong>: <span style="color:red;">Third Test. Sections 10.7, 10.8 and 10.10.</span></li>
        </ul> 
        ...
        <ul>
            ...
            <li><strong>Tu Nov 22</strong>: <span style="color:red;">Fourth Test. Sections 11.1 through 11.5.</span></li> 
        </ul>
