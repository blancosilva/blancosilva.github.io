...
<div class="well" style="font-family:Courier; background:white;">
    <ul style="font-family:Andale Mono;">
        ...
        <ul>
            ...
            <li><strong>Tu Oct 11</strong>: 10.4 & 10.5. Comparison tests (II). Alternating series.</li>
            <li><strong>Tu Oct 18</strong>: 10.6. Absolute and conditional convergence. Ratio and root tests</li>
