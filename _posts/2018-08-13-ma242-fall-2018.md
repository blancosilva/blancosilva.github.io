...
<div class="well">
	...
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">More population models.  Equilibrium solutions and stability</p>
			<p class="list-group-item-text">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">1.4.  Applications of Torricelli's Law</p>
