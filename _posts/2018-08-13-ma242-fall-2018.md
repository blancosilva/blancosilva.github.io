...
<div class="well">
	...
	<ul class="list-group">
		<li class="list-group-item">
			...
			<p class="list-group-item-text">7.1.  Laplace transform: Improper integrals revisited.</p>
			<p class="list-group-item-text">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">7.2. Laplace transform:  The Gamma function.</p>
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">7.4.  Laplace transform: Linearization, Differentiation of Transforms and Translation on the s-axis.</p>
			<p class="list-group-item-text">
		...
		<li class="list-group-item">
			...
			<p class="list-group-item-text">7.3.  Laplace transform: Integration of Transforms.  The Convolution property</p>
			<p class="list-group-item-text">
				<tt>[p.481 #1--16]</tt><br/>
				Find the Laplace transform of \( f(x) = \sin 3x \cos 3x \). <strong>int:</strong> Use the formula for the trigonometric function of the double angle.<br/>
				Find the inverse Laplace transform of \( F(s) = (s^2 + 4)^{-2} \). <strong>int:</strong> \( F \) looks like the derivative of another function.
			</p>
		</li>
		<li class="list-group-item">
			<p class="list-group-item-heading">
			...
			<p class="list-group-item-text">7.2.  Laplace transform: Laplace transform of derivatives.  Transformation of Initial Value Problems</p>
		</li>
		<li class="list-group-item">
