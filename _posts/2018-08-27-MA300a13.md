...
6. Suppose \\( a, b, c, \in \mathbb{Z} \\).  If \\( a \divides b \\) and \\( a \divides c \\) then \\( a \divides (b+c) \\).
7. Suppose \\( a, b \in \mathbb{Z} \\).  If \\( a \divides b \\) then \\( a^2 \divides b^2 \\).
8. Suppose \\( a \\) is an integer.  If \\( 5 \divides 2a \\), then \\( 5 \divides a \\).
9. Suppose \\( a \\) is an integer.  If \\( 7 \divides 4a \\), then \\( 7 \divides a \\).
10. Suppose \\( a \\) and \\( b \\) are integers.  If \\( a \divides b \\), then \\( a \divides (3b^3-b^2+5b) \\).
11. Suppose \\( a, b, c, d, \in \mathbb{Z} \\).  If \\( a \divides b \\) and \\( c \divides d \\), then \\( ac \divides bd \\).
...
19. Suppose \\( a, b \\) and \\( c \\) are integers,  If \\( a^2 \divides b \\) and \\( b^3 \divides c \\), then \\( a^6 \divides c \\).
20. If \\( a \\) is an integer and \\( a^2 \divides a \\), then \\( a \in \\{ -1,0,1 \\} \\).
...
27. Suppose \\( a, b \in \mathbb{N} \\).  If \\( \gcd(a,b)>1 \\), then \\( b \divides a \\) or \\( b \\) is not prime.
