	...
	<ul style="font-family:Andale Mono;">
		...
		<li><strong>Second Part: Functions of several variables</strong>
			<ul>
                ...
                <li><strong>Fri Oct 16</strong>: <font color="red">Second Midterm---sections 14.1--14.7</font><br />Click [<a href="\images\MA241.FA15.2.pdf">here</a>] to retrieve the exam.</li>
			</ul>
		</li>
