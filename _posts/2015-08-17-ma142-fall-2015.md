    ...
    <div class="col-sm-8 col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:ferrerrj@email.sc.edu" class="list-group-item">        
                ...
                <p class="list-group-item-text">
                    <strong>e-mail</strong>: <tt>ferrerrj at math dot sc dot edu</tt><br />
                    <strong>phone</strong>: <tt>777-7519</tt><br/>
                    <strong>Office</strong>: LeConte 317N
                </p>
            </a>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-lg-12">
        <table class="table table-bordered">
            ...
            <tr>
              ...
              <td bgcolor="#fedebe" style="text-align:right;">&nbsp;2:30 PM - &nbsp;3:30 PM</td>
              <td bgcolor="#fedebe" style="text-align:left;">LeConte 314D</td>
          </tr>
          <tr>
            <td bgcolor="#fedebe" style="text-align:center;">Josh</td>
            <td bgcolor="#fedebe" style="text-align:center;"><strong>MWF</strong></td>
            <td bgcolor="#fedebe" style="text-align:right;">&nbsp;1:00 PM - &nbsp;2:00 PM</td>
            <td style="text-align:left;" bgcolor="#fedebe">LeConte317N</td>
        </tr>
    </table>
</div>
</div>
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <strong>Final Exam</strong>: (up to 100 points) 30% of the course grade.<br />  The final exam is scheduled on Saturday, December 12th, 2015 at 12:30 PM.
            </li>
        </ul>
    </div>
</div>
...
<div class="well" style="font-family:Courier; background:white;">
    <ul style="font-family:Andale Mono;">
        ...
        <ul>
            ...
            <li><strong>Tue Oct 13</strong>: 11.2.  Introduction to series [p.694 #9, 11-40]</li>
            <li><strong>Thu Oct 15</strong>: 11.3.  The Integral test [p.703 #3--26]</li>
            <li><strong>Tue Oct 20</strong>: 11.4.  The Comparison test [p.709 #3--32]</li>
            <li><strong>Tue Oct 27</strong>: 11.5-11.6.  Absolute convergence.  The ratio and root tests [p.713 #2--20, p.719 #2--28]</li>
            <li><strong>Thu Oct 29</strong>: 11.8. Power series [p.727 #3-28]</li>
            <li><strong>Tue Nov 03</strong>: 11.9.  Functions as Power Series [p.733 #3--12, 15--17]</li>
            <li><strong>Thu Nov 05</strong>: 11.10.  Taylor and MacLaurin Series [p.746 #5--20]</li>
            <li><strong>Tue Nov 10</strong>: <span style="color:red;">Third Midterm. Sections 11.1-11.10</span> </li>
        </ul>
        <li>Part 4: Curves</li>
        <ul>
            ...
            <li><strong>Tue Nov 24</strong>: <span style="color:red;">Fourth Midterm. Chapter 10</span></li>
        </ul>
        <li>Final Stretch</li>
        <ul>
