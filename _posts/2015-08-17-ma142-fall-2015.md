    ...
    <div class="col-sm-8 col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:ferrerrj@email.sc.edu" class="list-group-item">        
                ...
                <p class="list-group-item-text">
                    <strong>e-mail</strong>: <tt>ferrerrj at math dot sc dor edu</tt><br />
...
The last day to obtain a "W" grade or to elect a pass/fail grade is Wednesday, August 26th. 
The first day in which a "WF" grade is assigned is therefore Thursday, August 27st.  
The last day to drop a course or withdraw without a grade of "WF" being recorded is Monday, October 12th.
    ...
    <div class="col-sm-12 col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item"><strong>Student Success Center:</strong><br />In partnership with University of South Carolina faculty, the Student Success Center (SSC) offers a number of programs to assist you in better understanding your course material and to aid you on your path to success.  SSC programs are facilitated by trained undergraduate peer leaders who have previously excelled in their courses.  Resources available to students in this course include:
                <ul>
                    <li><strong>Peer Tutoring:</strong> You can make a one-on-one appointment with a peer tutor by going to <a href="www.sc.edu/success">www.sc.edu/success</a>. Drop-in Tutoring and Online Tutoring may also be available for this course.  Visit the previous website for a full schedule of times, locations, and courses.</li>
