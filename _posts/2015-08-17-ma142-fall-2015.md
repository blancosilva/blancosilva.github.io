    ...
    <div class="col-lg-8">
        <div class="list-group">
            ...
            <a href="mailto:xyi@math.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading">Teaching Assistant: TBA</h4>
                <p class="list-group-item-text">
...
<div class="row">
    <div class="col-lg-12">
        <table class="table table-bordered">
          ...
          <tr>
            <td bgcolor="#fedebe" style="text-align:center;">TBA</td>
...
<div class="row">
    <div class="col-lg-12">
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <strong>Final Exam</strong>: (up to 100 points) 20% of the course grade.<br />  The final exams is scheduled on Saturday, December 12th, 2015 at 12:30 PM.
            </li>
        </ul>
    </div>
</div>
