...
The following is the list of <strong>non-advanced</strong> problems for Chapter 1 of the class notes.  There is a forum open at the end, so you can ask questions on how to proceed.  It is a great way to interact with the instructor and with other students in your class, should you need some assistance with any question. Please, <strong>do not post solutions</strong>.
</div>
