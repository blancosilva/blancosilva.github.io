    ...
    <div class="col-sm-8">
        <div class="list-group">
            ...
            <a href="mailto:edgarc@mailbox.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading">Teaching Assistant: Christopher David Edgar — sections 011 and 012</h4>
                <p class="list-group-item-text">
            ...
            <a href="mailto:hippl@mailbox.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading">Teaching Assistant: Rita Barnwell Hipp — sections 015 and 016</h4>
                <p class="list-group-item-text">
