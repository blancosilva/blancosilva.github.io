...
<div class="row">
    ...
    <div class="col-sm-8">
        <div class="list-group">
            <a href="mailto:blanco@math.sc.edu" class="list-group-item active">
            ...
            <a href="mailto:edgarc@mailbox.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading">TA (sections 11, 12): Christopher David Edgar</h4>
                <p class="list-group-item-text">
            ...
            <a href="mailto:hippl@mailbox.sc.edu" class="list-group-item">        
                <h4 class="list-group-item-heading">TA (sections 15, 16): Rita Barnwell Hipp</h4>
                <p class="list-group-item-text">
    ...
    <div class="col-sm-12">
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <h3 style="text-align:center;"><span class="label label-primary"><tt>sc 7564 8382</tt></span></h3>
