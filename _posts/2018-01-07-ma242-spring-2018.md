		...
		<div class="list-group">
            <a href="mailto:blanco@math.sc.edu" class="list-group-item">
                ...
                <p class="list-group-item-text">
                    ...
                    <strong>Office Hours</strong>: MW 2:00 - 4:00 PM, F 2:00 — 3:00 PM
                </p>
            </a>
        </div>
	</div>	
	...
	<div class="col-sm-12 col-lg-12">
		<ul class="list-group">
        	...
        	<li class="list-group-item">
        		...
        		If you have taken at least three of the in-class exams, and are unhappy with your potential final score (as computed with the formula above), notify me <strong>by email on Thursday, April 26, before 6:00 PM.</strong>  You will have an opportunity to change your course grade by taking a (comprehensive) final exam.  <strong>The score of the final will substitute your previous grade</strong>.
        		<ul>
	...
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<ul style="font-family:Courier;" >
				...
				<li>
					...
					[<a href="https://www.dropbox.com/s/4f751842lr95ja6/lesson19ma242.pdf">slide</a> | <a href="https://www.dropbox.com/s/hlv6b926ialjs4i/lesson20ma242.pdf">slide</a>]<br/>
		...
		<li class="list-group-item">
			...
			<ul style="font-family:Courier;" >
				...
				<li>
					<span style="color:red;"><strong>Tue Mar 27:</strong> Integration Challenge</span>
				</li>
				<li>
					<strong>Thu Mar 29:</strong> Review
				</li>
				<li>
					<span style="color:red;"><strong>Tue Apr 03:</strong> Third Test</span>
				</li>
				<li>
					<strong>Thu Apr 05: 3.4.</strong><br/>
				...
				<li>
					<strong>Tue Apr 10: 3.6.</strong><br/>
					Mechanical vibrations:<br/>
				...
				<li>
					<strong>Thu Apr 12:</strong> Review
				</li>
				<li>
					<span style="color:red;"><strong>Tue Apr 17:</strong> Fourth Test</span>
				</li>
				<li>
