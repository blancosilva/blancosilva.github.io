	...
	<div class="col-sm-12 col-lg-12">
		<ul class="list-group">
        	...
        	<li class="list-group-item">
        		...
        		If you have taken at least three of the in-class exams, and are unhappy with the final score obtained from the in-class exams, notify me <strong>by email on Thursday, April 26, before 6:00 PM.</strong>  You will have an opportunity to change your course grade by taking a (comprehensive) final exam.<br/>
	...
	<ul class="list-group">
		<li class="list-group-item"><strong>First part: Introduction to Differential Equations</strong>
			<ul style="font-family:Courier;" >
				...
				<li>
					<span style="color:red;"><strong>Tue Feb 06:</strong> First Test</span>
				</li>
				<li>
